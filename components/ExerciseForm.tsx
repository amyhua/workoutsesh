          ...
          <div className="flex mb-3">
            <div className="relative">
              <input
                ...
                placeholder="0"
              />
              <label className="absolute left-4 top-3.5">Minutes</label>
            </div>
            <div className="relative">
              <input
                className="pl-[95px] flex-1 ml-2 rounded-lg text-base w-full p-3 mb-3 border-2 border-black focus:border-black focus:outline-none"
                type="number"
                name="restTimeLimit"
                ...
                placeholder="0"
              />
              <label className="absolute left-6 top-3.5">Seconds</label>
            </div>
          </div>
        </>
      }
