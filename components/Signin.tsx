...
const Signin = () => {
  ...
  console.log('router query', router.query, session);
    ...
    <Layout title="Sign in | Workout Sesh" background="white">
      <main className="relative max-w-lg mx-auto h-full min-h-[800px] p-5">
        ...
        <div className="mx-10 py-10">
          {
            authError &&
            <div className="my-2 text-sm p-3 rounded-lg bg-red-100 text-red-700">
